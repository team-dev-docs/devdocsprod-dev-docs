...
This incident "ruined a Saturday" as we had to take immediate action to rotate our API keys in our services. Although we trust GitHub's practices not to train on sensitive items, we couldn't be, necessitating this precautionary measure.
