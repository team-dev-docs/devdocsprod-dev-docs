...
To generate docs based on your code objects select **AI tools** in the top right hand corner of the web editor and navigate to **Code objects** in the dropdown menu.
