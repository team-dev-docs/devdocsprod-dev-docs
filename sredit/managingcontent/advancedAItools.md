...
This feature allows you to have AI scan your existing documentation based on what you would like it to search for. You can add any prompt you choose into the **Describe what you want to audit field. If you would like for the AI to also check your docs against your code**
