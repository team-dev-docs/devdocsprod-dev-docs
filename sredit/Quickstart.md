...
Once you have installed the GitHub App and selected which repo(s) to connect, come back to Docs.dev and close the loop by inputting which repo your documentation lives in. Congrats! Now you're all set up and ready to go! Select **Edit docs** to open up the web editor and get going.
