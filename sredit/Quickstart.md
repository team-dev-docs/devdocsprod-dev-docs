...
Once you have installed the GitHub App and selected which repo(s) to connect it to, come back to Docs.dev and close the loop by inputting which repo your documentation lives in. Now you're all set up and ready to go! Click into **Edit docs** to open up the web editor
