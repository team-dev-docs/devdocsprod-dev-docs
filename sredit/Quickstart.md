...
We recommend you start by providing access to only the repo where your docs are hosted from to start. However, in order to take full advantage of [Docs.dev](http://Docs.dev) you can
