...
Select use our template. You will be taken to GitHub where you will be prompted to create a new repository. Follow the steps in GitHub and come back to [app.docs.dev](https://app.docs.dev/) once the repo is set up. From here, go to Connect your existing docs above
