...
Select **Connect your own docs** and click on **Install the GitHub Ap**p to begin the integration process. Clicking this will take you out of Docs.dev and into your GitHub where you can install and set up the Dev-Docs GitHub App.
