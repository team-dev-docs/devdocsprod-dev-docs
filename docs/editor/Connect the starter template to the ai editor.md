...
From the dropdown, find your newly created docs repository. Feel free to connect any other public codebases you would like the app to have access to as context. Be sure to select it and select **Save.**
