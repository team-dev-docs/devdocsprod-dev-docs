...
Once the , go back to the [Docs.dev](http://Docs.dev) web app and confirm that your repository name matches your desired [Docs.dev](http://Docs.dev) organization and select **Complete GitHub App Setup**.
