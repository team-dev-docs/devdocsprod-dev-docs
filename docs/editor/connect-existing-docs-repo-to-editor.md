...
Once done, go back to the Docs.dev web app and confirm that your repository name matches your desired Docsev organization and click "Complete GitHub App Setup".
