...
Everything generated here will go back into the web editor so you can edit as you see fit and then push to the GitHub branch of your choosing when ready. The generated pages will be automatically pushed to the editing branch you have selected on the top left corner of the web editor. You can always go back to GitHub or your local environment to edit the raw markdown as well.
