...
# Customize Your AI Generation test
...
Find your `dev-docs.json` file. ![](/img/customize_your_ai_generation/step_5.png)
...
Make sure you are signed in and then select the file you wish to be documented. From there, open the command palette, search and select **dev-docs: generate documentation** or run shift command d. ![](/img/generate_documentation_with_ai/step_5.png)
