...
export default function WavyBackgroundDemo() {
  ...
  return (
    ...
    <div style={backgroundStyle} className="h-[50rem] w-full dark:bg-black bg-white  dark:bg-grid-white/[0.2] bg-grid-black/[0.2] relative flex items-center justify-center">
