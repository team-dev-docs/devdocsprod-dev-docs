        ...
        <div className="h-[50rem] w-full bg-transparent relative flex items-center justify-center">
          ...
          <div className="text-white p-4 sm:p-24 flex flex-col items-start justify-between">
            ...
            <div className="flex space-x-2 mt-2">
              ...
              <a href="https://calendly.com/srchat/dev-docs-founders" className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6 text-white inline-flex items-center">
                <span className="absolute inset-0 overflow-hidden rounded-full">
                  <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                </span>
                <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 ">
